...
* @str: the opcode
*
* Return: returns afunction, or NULL on failure
*/
...
/**
* parse_line - parses a line fpr an opcode and argument
...
char *parse_line(char *line, stack_t **stck, unsigned it line_number)
{
