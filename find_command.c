...
* @stack: Dounle pointer pointing to top of the stack/queue
...
/**
* int_check - Check if teh given argument to push is a valid integer or not
* @push_arg: The string argument found after the push opcode
*
* Return: 1 if not an integer else 0
*/
...
* @stack: Double pointer to the top of the stack
* @push_value: The value to assigne to the new node
*/
